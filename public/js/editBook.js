...
function loadStatus() {
  var bookStatus = $('.book-status').val();
...
$('.status-box').on('click', function () {
  var statusIconClass = $(this).children().children().attr('class');
  var bookStatus = $('.book-status').val();
...
$('#deleteCheckBox').on('click', function () {
  var deleteForm = $(this).parent().parent().parent();
  var checkBox = deleteForm.find('#deleteCheckBox').prop('checked');
  var deleteButton = deleteForm.find('.common-button');
